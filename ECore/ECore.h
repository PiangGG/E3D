...
namespace E3D
{
	...
	#define EPOLY_ATTR_SHADE_MODE_FASTPHONG 0x0020 // (alias)多边形属性着色模式FASTPHONG
	#define EPOLY_ATTR_SHADE_MODE_TEXTURE   0x0040	//多边形属性着色模式纹理
	...
	#define EOBJECT_STATE_ACTIVE			0x0001	//活动
	#define EOBJECT_STATE_VISIBLE			0x0002	//可见
	#define EOBJECT_STATE_CULLED			0x0004	//剔除
